...
export default function AdminUsers() {
  ...
  const suspendUser = async (id) => {
    ...
    await axios.put(
      `${API_BASE}/api/admin/user/${id}/suspend`,
      {},
      { headers }
    );
  ...
  const activateUser = async (id) => {
    ...
    await axios.put(
      `${API_BASE}/api/admin/user/${id}/activate`,
      {},
      { headers }
    );
  ...
  const isSuperAdmin =
    currentUserEmail === "washingtonamedu@gmail.com";
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <div>
            ...
            <p className="text-blue-100 max-w-2xl">
              Manage access, roles, units, account status,
              and user activity from one centralized dashboard.
            </p>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                {userActivity.map((tx) => (
                  ...
                  <div
                    key={tx._id}
                    className="bg-gray-100 dark:bg-[#202020] rounded-2xl p-5"
                  >
