...
const defaultServiceCatalog = [
  { serviceCode: 'validation-noRecord', category: 'NIN', name: 'No Record', type: 'noRecord', status: 'active', price: 1000, metadata: { description: 'Identify when a NIN record is missing or unavailable.', formFields: [] } },
  ...
  { serviceCode: 'validation-vnin', category: 'NIN', name: 'V-NIN Validation', type: 'vnin', status: 'active', price: 1000, metadata: { description: 'Verify a V-NIN linked to a valid NIN record.', formFields: [] } },
  ...
  { serviceCode: 'modification-name', category: 'NIN', name: 'Name Modification', type: 'name', status: 'active', price: 12000, metadata: { description: 'Correct name, surname, or spelling records.', formFields: [] } },
  ...
  { serviceCode: 'modification-dob', category: 'NIN', name: 'DOB Modification & NPC Attestation', type: 'dob', status: 'active', price: 50000, metadata: { description: 'Correct date of birth and request NPC attestation support.', formFields: [] } },
...
const normalizeCatalogService = (service = {}, fallback = {}) => ({
  ...
  metadata: service.metadata || fallback.metadata || {},
});
