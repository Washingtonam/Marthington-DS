              ...
              <div className="p-5">
                <div className="space-y-3 mb-5">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold capitalize dark:text-white">{r.type}</span>
                  </div>
                  <div className="flex justify-between">
            ...
            <div className="sticky top-0 bg-white dark:bg-[#111111] border-b border-gray-200 dark:border-gray-800 p-6 z-10">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Full operational overview</p>
                </div>
                <button
            ...
            <div className="p-6">
              ...
              <div className="bg-gray-50 dark:bg-[#181818] rounded-3xl p-6 mb-6 border border-gray-100 dark:border-gray-800">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg dark:text-white">Customer Information</h3>
                    <p className="text-sm text-gray-500">Request owner details</p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div className="bg-white dark:bg-[#111111] rounded-2xl p-4 border border-gray-100 dark:border-gray-800">
                    ...
                    <p className="text-gray-500 mt-1 break-all">{selected.userId?.email}</p>
                  </div>
                  <div className="bg-white dark:bg-[#111111] rounded-2xl p-4 border border-gray-100 dark:border-gray-800">
                    <b className="dark:text-white">NIN</b>
                    <p className="text-gray-500 mt-1">{selected.nin}</p>
                  </div>
                  <div className="bg-white dark:bg-[#111111] rounded-2xl p-4 border border-gray-100 dark:border-gray-800">
                    <b className="dark:text-white">Service</b>
                    <p className="text-gray-500 mt-1 capitalize">{selected.service}</p>
                  </div>
                  <div className="bg-white dark:bg-[#111111] rounded-2xl p-4 border border-gray-100 dark:border-gray-800">
                    <b className="dark:text-white">Type</b>
                    <p className="text-gray-500 mt-1 capitalize">{selected.type}</p>
                  </div>
                </div>
              </div>

              {/* FORM DATA (UPGRADED FOR TRACKING ID & CAC FILE UPLOADS) */}
              <div className="bg-gray-50 dark:bg-[#181818] rounded-3xl p-6 mb-6 border border-gray-100 dark:border-gray-800">
                <h3 className="font-bold text-lg mb-5 dark:text-white">Submitted Form Data</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  {Object.entries(selected.formData || {}).map(([k, v]) => {
                    ...
                    // Cleans keys like 'trackingId' or 'businessName' into readable titles
                        ...
                        <div>
                          ...
                          {isImage ? (
                            <img
                              ...
                              className="w-full h-32 object-cover rounded-xl border cursor-pointer hover:opacity-90 transition mt-1"
                            />
                          ) : isUrl ? (
                            <a
                              href={v}
                              target="_blank"
                              rel="noreferrer"
                              className="text-sm text-blue-500 hover:underline break-all block font-medium mt-1"
                            >
                              View Attached File ↗
                            </a>
                          ) : (
                            <p className="text-sm dark:text-white break-words font-semibold mt-1">
                              {String(v)}
                            </p>
                          )}
                        </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                {selected.proof && (
                  <div className="bg-gray-50 dark:bg-[#181818] rounded-3xl p-6 border border-gray-100 dark:border-gray-800">
                    <h3 className="font-bold text-lg mb-4 dark:text-white">Payment Proof</h3>
                    <img
                      src={selected.proof}
                      alt="proof"
                ...
                {selected.passport && (
                  <div className="bg-gray-50 dark:bg-[#181818] rounded-3xl p-6 border border-gray-100 dark:border-gray-800">
                    <h3 className="font-bold text-lg mb-4 dark:text-white">Passport Photograph</h3>
                    <img
              ...
              <div className="bg-gray-50 dark:bg-[#181818] rounded-3xl p-6 mb-6 border border-gray-100 dark:border-gray-800">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg dark:text-white">Admin Notes</h3>
                    <p className="text-sm text-gray-500">Internal processing notes</p>
                  </div>
                </div>
                <textarea
                  value={note}
              ...
              <div className="bg-gray-50 dark:bg-[#181818] rounded-3xl p-6 border border-gray-100 dark:border-gray-800">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg dark:text-white">Team Comments</h3>
                    <p className="text-sm text-gray-500">Internal discussion thread</p>
                  </div>
                </div>
                    ...
                    selected.comments.map((c, i) => (
                      ...
                      >
                        <div className="flex justify-between items-center mb-2">
                          <p className="font-semibold text-sm dark:text-white">{c.by}</p>
                        </div>
        ...
        <div className="fixed inset-0 bg-black/90 z-[100] flex justify-center items-center p-4">
          <div className="relative max-w-5xl w-full">
            <button
              ...
              className="absolute -top-14 right-0 bg-red-600 hover:bg-red-700 text-white px-5 py-2 rounded-2xl z-50"
            >
              Close
            </button>
            <img
